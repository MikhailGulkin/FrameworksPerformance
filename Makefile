...
# http alch
up-aiohttp-w-4-alch:
	gunicorn Servers.aiohttp_sqlalchemy.server:app --workers 4 --worker-class aiohttp.GunicornWebWorker --bind 0.0.0.0:5004
up-aiohttp-w-12-alch:
	gunicorn Servers.aiohttp_sqlalchemy.server:app --workers 12 --worker-class aiohttp.GunicornWebWorker --bind 0.0.0.0:5004
...
up-sheep:
	gunicorn Servers.black_sheep.server:app -k uvicorn.workers.UvicornWorker --bind 0.0.0.0:5006
up-sheep-w-12:
